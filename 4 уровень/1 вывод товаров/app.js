...
let objProducts = document.querySelector('.products');
...
function clickHandler(event) {
    ...
    showCategory(event.getAttribute('data-type'));
...
function showCategory(category) {
    ...
    let markup = '';
    productsCategory.forEach(function (input) {
        markup += getProductMarkup(input);
    });
    objProducts.insertAdjacentHTML("afterbegin", markup);
}
